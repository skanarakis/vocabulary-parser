...
public class ParserStaticConstants {
    ...
    public static final String TEST_IMAGES_PATH = TEST_RESOURCES_PATH + "/textImages/";
    public static final String TEST_PUBLISHERS_PATH = TEST_RESOURCES_PATH + "/publishers/";
